...
const PromoPopup = () => {
    ...
    isVisible && (
        ...
        <div className="relative bg-white p-4 shadow-lg max-w-xs md:max-w-md text-center animate-popup w-10/12 sm:w-8/12 md:w-auto cursor-none">
            <button
            onClick={closePopup}
            ...
            <video controls className="mb-4 mx-auto w-full h-auto cursor-none" autoPlay loop muted>
