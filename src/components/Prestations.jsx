  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="text-8xl font-caslon text-black mb-2">
            NOS PRESTATIONS
          </h1>
          <p className="uppercase tracking-widest text-gray-600">Swiper</p>
          ...
          >
            ...
            <div className="absolute bottom-10 left-10">
              {item.cta && (
                <a
                  href={item.link}
                  className="text-black text-md animate-pulse-custom"
                >
                  Découvrir
                </a>
              )}
              <h2 className="text-4xl text-black">{item.title}</h2>
            </div>
          </div>
        ))}
      </div>
